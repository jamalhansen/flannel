...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<["treetop", "polyglot"]>, [">= 0"])
      s.add_development_dependency(%q<["shoulda", "mocha"]>, [">= 0"])
    else
      s.add_dependency(%q<["treetop", "polyglot"]>, [">= 0"])
      s.add_dependency(%q<["shoulda", "mocha"]>, [">= 0"])
    end
  else
    s.add_dependency(%q<["treetop", "polyglot"]>, [">= 0"])
    s.add_dependency(%q<["shoulda", "mocha"]>, [">= 0"])
